...
## 3. Diff expr:
Here there is a problem with R version, since DESeq2 specific version is required. One solution would be to create a conda env with the correct R version
