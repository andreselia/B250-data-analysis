...
UPDATE: The general tables are created with the /subsequence_analysis.sh script in step 2.1

```
bsub -q long -R "rusage[mem=50G]" /omics/groups/OE0532/internal/Alex/scripts/subsequence_analysis_tables.sh 20910 mm10 50 all_samples all_unique
bsub -q long -R "rusage[mem=50G]" /omics/groups/OE0532/internal/Alex/scripts/subsequence_analysis_Mito_tables.sh 20910 mm10 50 all_samples all_unique
bsub -q long -R "rusage[mem=50G]" /omics/groups/OE0532/internal/Alex/scripts/subsequence_analysis_subset_tables.sh 20910 mm10 50 all_samples all_unique
```
